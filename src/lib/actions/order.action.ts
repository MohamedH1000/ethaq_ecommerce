  ...
  try {
    ...
    const adminEmailTemplate = `
      ...
      address?.city
            ...
            <a href="https://admin.ethaq.store/admin/requests" class="button">الذهاب إلى لوحة التحكم</a>
          </div>
          <div class="footer">
    ...
    //   نشكرك على طلبك الجديد، لقد تم إرسال طلبك بنجاح ✅

    //   🔐 *عند استلام الطلب يرجى تأكيد الاستلام بالكود التالي:*
    //   📌 *${newOrder.confirmNo}* 📌

    //   👉 الرابط المختصر لتأكيد الاستلام:
    //   ${`https://ethaq.store/account/orders/${newOrder?.id}`}
    ...
    //   sendWATIMessage(
    //     "+962780828916", // Admin number
    //     adminWhatsAppMessage
    //   ),
    //   sendWATIMessage(
    //     user?.phone || "+962780828916", // User's phone number
    //     userWhatsAppMessage
    //   ),
    // ];
